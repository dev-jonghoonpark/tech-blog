...
이러한 더블 중에서도 오직 목 만 행동 검증을 합니다. 다른 더블들은 상태 확인을 사용할 수 있으며, 일반적으로 사용합니다. 실행 단계에서는 다른 더블과 차이가 없으나, 준비 및 확인 단계에서는 다릅니다.
...
이 글의 나머지 부분에서는 Classical and Mockist 에 대해서 다룹니다. 이 부분은 후에 기회가 되면 이어서 작성해보겠습니다.
