...
description: "컴파일러 중간 표현(IR) 기법인 Three-Address Code와 정적 단일 할당(SSA)을 소개합니다. 코드 최적화를 위한 IR 변환 원리와 phi 함수의 역할을 다룹니다."
categories:
  - "개발"
tags:
  - "SSA"
...
**[Three-Address Code(3AC)](https://en.wikipedia.org/wiki/Three-address_code)**는 하나의 명령문에 **최대** 3개의 주소(피연산자 2개 + 결과값 1개)를 가지는 형태로 표현하는 중간 표현이다. 일반적으로 다음과 같은 형태를 가진다.
