---
layout: "post"
title: "Spring 기반 프로젝트에서 Service 클래스 안의 로직에 대한 테스트를 시도 하면서 경험한 것 (로직 분리, 함수형 프로그래밍\
  , 순수 함수)"
description: "Spring 기반 프로젝트에서 서비스 클래스의 로직 테스트를 시도하며, 비즈니스 로직의 중요성과 테스트 코드 작성의 필요성\
  을 느꼈습니다. 초기화 과정에서 발생하는 시간 지연 문제를 해결하기 위해 로직을 별도의 클래스로 분리하고 순수 함수 형태로 구현하여 테스트 시간\
  을 30초에서 7초로 단축했습니다. 이 경험을 통해 함수형 프로그래밍의 중요성을 깨달았으며, 테스트 효율성을 높이기 위한 개선 방안을 모색할 예\
  정입니다."
categories:
- "개발"
- "스터디-테스트"
...
- "Mock"
- "Scan"
date: "2023-12-01 06:30:00 +0000"
toc: true
image:
  path: "/assets/thumbnails/2023-12-01-spring-test-service-안의-로직-테스트하기.jpg"
---
