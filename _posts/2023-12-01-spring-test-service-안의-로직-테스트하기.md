...
description: Spring 기반 프로젝트에서 서비스 클래스의 로직 테스트를 시도하며, 비즈니스 로직의 중요성과 테스트 코드 작성의 필요성을 느꼈습니다. 초기화 과정에서 발생하는 시간 지연 문제를 해결하기 위해 로직을 별도의 클래스로 분리하고 순수 함수 형태로 구현하여 테스트 시간을 30초에서 7초로 단축했습니다. 이 경험을 통해 함수형 프로그래밍의 중요성을 깨달았으며, 테스트 효율성을 높이기 위한 개선 방안을 모색할 예정입니다.
